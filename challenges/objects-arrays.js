...
*/
const displayNames = [];
let bothNames = zooAnimals.forEach((anny) => {
    displayNames.push(`Name: ${anny.animal_name}, Scientific: ${anny.scientific_name}`);
});
...
let lowCaseAnimalNames = zooAnimals.map((zooAnimal) => {
...
*/
let lowPopulationAnimals = zooAnimals.filter((larger) => {
